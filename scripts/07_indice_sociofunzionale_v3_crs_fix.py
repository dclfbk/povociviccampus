...
def main() -> int:
    ...
    # GeoJSON RFC 7946 / uMap: coordinate geografiche WGS84, longitudine-latitudine.
    if gdf.crs is None:
        raise ValueError(
            "Il layer delle sezioni non ha un CRS definito. "
            "Assegnare il CRS corretto prima di esportare il GeoJSON."
        )
