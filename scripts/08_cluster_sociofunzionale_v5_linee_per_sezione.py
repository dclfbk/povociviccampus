...
Linee urbane con fermata nella sezione: {gtfs__linee_urbane_con_fermata_nella_sezione}
Linee extraurbane con fermata nella sezione: {gtfs__linee_extraurbane_con_fermata_nella_sezione}
Fermata più accessibile: {gtfs__fermata_migliore}
Tempo a piedi: {tempo_fermata_label}
